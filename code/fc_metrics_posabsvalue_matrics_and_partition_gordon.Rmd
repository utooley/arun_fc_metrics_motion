...
p<-ggplot(toplot, aes(x=variable, y=value, fill=variable)) + 
  ...
  theme_classic() 
p
+ labs(title="333-node Gordon parcellation",x="Baseline Edge weight distribution", y = "Modularity quality index Q")+ theme(plot.title = element_text(hjust = 0.5))+ theme(axis.text=element_text(size=14),
...
```{r load data, include=FALSE}
data_dir="~/Documents/projects/in_progress/arun_fc_metrics_motion/"
dropbox_data="/cbica/home/tooleyu/projects/in_progress/arun_fc_metrics_motion/output/Schaefer_100_ICA_FIX/"
